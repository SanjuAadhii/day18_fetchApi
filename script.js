...
function bar(data){
    ...
    for(let i=0;i<data.length;i++){
        ...
        <h5 class="card-title" style="background-color:black;color:white;padding:5px" >${data[i].name.common}</h5>
        <img src="${data[i].flags.svg}" style="padding:10px; height:200px" alt="flag">
        <div class="card-body ">
